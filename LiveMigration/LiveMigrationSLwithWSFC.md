...
If you are not familiar with ECX cluster configuration, you can follow this [guide](EC_Config.md) to set up the cluster with the required ECX resources. The key ECX resources required with the settings which need to be modified are included below for reference.
- Witness heartbeat
- LAN heartbeat
- HTTP NP
- Floating IP address
